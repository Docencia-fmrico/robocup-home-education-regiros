...
#include "ros/ros.h"
#include "takeluggage/WaitForOrder.h"
#include "behaviortree_cpp_v3/behavior_tree.h"
#include <string>

namespace takeluggage
{
  WaitForOrder::WaitForOrder(const std::string& name)
...
{
  factory.registerNodeType<takeluggage::WaitForOrder>("WaitForOrder");
}
