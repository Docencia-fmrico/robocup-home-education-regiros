...
{
  ros::init(argc, argv, "recepcionist");
  ros::NodeHandle n;
  ...
  factory.registerFromPlugin(loader.getOSName("asr_sendentry_bt_node"));
  factory.registerFromPlugin(loader.getOSName("asr_sendsit_bt_node"));
  factory.registerFromPlugin(loader.getOSName("asr_goposition_bt_node"));
  factory.registerFromPlugin(loader.getOSName("asr_gorefere_bt_node"));
  ...
  std::string pkgpath = ros::package::getPath("recepcionist");
  std::string xml_file = pkgpath + "/behavior_trees/bt_recepcionist.xml";
